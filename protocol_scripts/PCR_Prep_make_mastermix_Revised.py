...
def get_values(*names):
    import json
    _all_values = json.loads("""{"right_pipette":"p300_single_gen2","left_pipette":"p20_multi_gen2","master_mix_csv":"Reagent,Slot,Well,Volume\\nBuffer,1,A2,3\\nMgCl,1,A3,40\\ndnNTPs,2,A2,90\\nddH2O,2,A3,248\\nPrimer_Fwd,1,A4,25\\nPrimer_Rev,1,A5,25\\n"}""")
...
def run(protocol_context):
    ...
    res12 = protocol_context.load_labware( #might need to change this for 
        'nest_12_reservoir_15ml', '3', '12-channel reservoir')
    reagents = {
        '1': snaprack,
        '2': screwrack,
        '3': res12
